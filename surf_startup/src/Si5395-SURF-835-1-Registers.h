 ...
 *
 * This file represents a series of Silicon Labs Si5395 Rev A 
 ...
 * Timestamp:                                          2022-06-13 15:31:01 GMT-04:00
 *
...
// THIS IS CHEATED
// WE ADD TWO EXTRA HERE TO INDICATE DELAYS
#define SI5395_REVA_REG_CONFIG_NUM_REGS				597
 ...
 * Project File:       V:\surf_test\si5395\Si5395-SURF-Project.slabtimeproj
 * Design ID:          835-1
 * Created By:         ClockBuilder Pro v2.43 [2020-03-31]
 * Timestamp:          2022-06-13 15:31:00 GMT-04:00
 * 
 * Design Notes
 * ============
 * This is a modified version of the Si5395 from Trenz Electronik to support the SURFv6 frequency plan.
 * 
 * The SURFv6 uses CLKA/B/C/D as the ADC clocks, CLK8_P/N and CLK0A_100MHz_P/N as the PL and analog SYSREF respectively. CLKE_P/N is used as the logic clock of 187.5 MHz. Note that CLK0A_100MHz_P/N is merely the name it has in the TE0835 schematic: it could have been called anything.
 * 
 * Finally the B128/B129 and PSMGT clocks run at 125 MHz.
 * 
 * Additionally, the design takes both the 25 MHz internal and 7.8125MHz external clocks, with the external clock preferred.
 * 
 * Design Rule Check
 * =================
 * Errors:
 ...
 * Device Grade
 * ============
 * Maximum Output Frequency: 187.5 MHz
 ...
 *    N0:
 *       Value: 18
 *       OUT0: 187.5 MHz [ 187 + 1/2 MHz ]
 *       OUT1: 187.5 MHz [ 187 + 1/2 MHz ]
 *       OUT2: 187.5 MHz [ 187 + 1/2 MHz ]
 *       OUT3: 187.5 MHz [ 187 + 1/2 MHz ]
 *       OUT4: 187.5 MHz [ 187 + 1/2 MHz ]
 *       OUT6: 125 MHz
 *       OUT7: 125 MHz
 *       OUT8: 7.8125 MHz [ 7 + 13/16 MHz ]
 *       OUT9: 125 MHz
 *       OUT9A: 7.8125 MHz [ 7 + 13/16 MHz ]
 *    N1:
 *       Unused
 *    N2:
 *       Unused
 ...
 * Airflow:  2 m/s
 * 
 * Total Power: 898 mW, On Chip Power: 838 mW, Tj: 40 °C
 * 
 *          Frequency  Format   Voltage   Current     Power
 *         ----------  ------  --------  --------  --------
 * VDD                            1.8 V  131.4 mA    237 mW
 * VDDA                           3.3 V  115.2 mA    380 mW
 * VDDO0A      Unused                                      
 * VDDO0    187.5 MHz  LVDS       1.8 V   15.9 mA     29 mW
 * VDDO1    187.5 MHz  LVDS       1.8 V   15.9 mA     29 mW
 * VDDO2    187.5 MHz  LVDS       1.8 V   15.9 mA     29 mW
 * VDDO3    187.5 MHz  LVDS       1.8 V   15.9 mA     29 mW
 * VDDO4    187.5 MHz  LVDS       1.8 V   15.9 mA     29 mW
 * VDDO5       Unused                                      
 * VDDO6      125 MHz  LVDS       1.8 V   15.6 mA     28 mW
 * VDDO7      125 MHz  LVDS       1.8 V   15.6 mA     28 mW
 * VDDO8   7.8125 MHz  LVDS       1.8 V   15.1 mA     27 mW
 * VDDO9      125 MHz  LVDS       1.8 V   15.6 mA     28 mW
 * VDDO9A  7.8125 MHz  LVDS       1.8 V   15.1 mA     27 mW
 *                                       --------  --------
 *                                Total  402.7 mA    898 mW
 * 
 * Note:
 * 
 ...
 * 0x0018[3:0]   LOS_INTR_MSK                10                 0xA              
 * 0x0018[7:4]   OOF_INTR_MSK                10                 0xA              
 ...
 * 0x002E[15:0]  LOS0_TRG_THR                70                 0x0046           
 * 0x0030[15:0]  LOS1_TRG_THR                0                  0x0000           
 * 0x0032[15:0]  LOS2_TRG_THR                70                 0x0046           
 ...
 * 0x003E[7:4]   LOS_MIN_PERIOD_EN           5                  0x5              
 * 0x003F[3:0]   OOF_EN                      5                  0x5              
 * 0x003F[7:4]   FAST_OOF_EN                 5                  0x5              
 * 0x0040[2:0]   OOF_REF_SEL                 4                  0x4              
 * 0x0041[4:0]   OOF0_DIV_SEL                11                 0x0B             
 * 0x0042[4:0]   OOF1_DIV_SEL                0                  0x00             
 * 0x0043[4:0]   OOF2_DIV_SEL                9                  0x09             
 ...
 * 0x005A[25:0]  OOF0_RATIO_REF              15534459           0x0ED097B        
 ...
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256        12736              0x000031C0       
 ...
 * 0x0208[47:0]  P0_NUM                      16                 0x000000000010   
 ...
 * 0x0235[43:0]  MXAXB_NUM                   536870912000       0x07D00000000    
 ...
 * 0x025F[23:0]  R7_REG                      2                  0x000002         
 * 0x0262[23:0]  R8_REG                      47                 0x00002F         
 * 0x0265[23:0]  R9_REG                      2                  0x000002         
 * 0x0268[23:0]  R9A_REG                     47                 0x00002F         
 ...
 * 0x0510[5:0]   FASTLOCK_BW2_PLL            8                  0x08             
 * 0x0511[5:0]   FASTLOCK_BW3_PLL            7                  0x07             
 * 0x0512[5:0]   FASTLOCK_BW4_PLL            7                  0x07             
 * 0x0513[5:0]   FASTLOCK_BW5_PLL            63                 0x3F             
 * 0x0515[55:0]  M_NUM                       3710851743744      0x00036000000000 
 ...
 * 0x0532[23:0]  HOLD_15M_CYC_COUNT          1067               0x00042B         
 ...
 * 0x0538[2:0]   IN0_PRIORITY                2                  0x2              
 * 0x0538[6:4]   IN1_PRIORITY                0                  0x0              
 * 0x0539[2:0]   IN2_PRIORITY                1                  0x1              
 * 0x0539[6:4]   IN3_PRIORITY                0                  0x0              
 * 0x053A[1:0]   HSW_MODE                    1                  0x1              
 ...
 * 0x0588[3:0]   HSW_FINE_PM_LEN             7                  0x7              
 * 0x0589[12:0]  CAP_SHORT_DELAY             14                 0x000E           
 * 0x058B[19:0]  HSW_MEAS_SETTLE             20595              0x05073          
 ...
 * 0x05AD[15:0]  OUT_MAX_LIMIT_LMT           16384              0x4000           
 * 0x05B1[15:0]  HOLD_SETTLE_TARGET          671                0x029F           
 ...
 * 0x0949[3:0]   IN_EN                       5                  0x5              
 * 0x0949[7:4]   IN_PULSED_CMOS_EN           1                  0x1              
 * 0x094A[3:0]   INX_TO_PFD_EN               5                  0x5              
 ...
 * 0x0B47[4:0]   OOF_CLK_DIS                 10                 0x0A             
 * 0x0B48[4:0]   OOF_DIV_CLK_DIS             10                 0x0A             
 ...
 * 0x0C03[3:0]   IN_CLK_VAL_PWR_UP_DIS       5                  0x5              
